  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        input: "hsl(var(--input))",
        ring: "hsl(var(--ring))",
        background: "hsl(var(--background))", // This will be overridden by the gradient in globals.css
        ...
        // Custom colors for light/dark mode backgrounds (used in CSS variables)
